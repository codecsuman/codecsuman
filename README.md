...
[![Live Demo](https://img.shields.io/badge/🌐_Live_Demo-Vercel-000000?style=for-the-badge&logo=vercel&logoColor=white)](https://doctor-appointment-booking-roan.vercel.app/)
...
**Tech:** `Python` · `Pandas` · `NumPy` · `Plotly` · `Faker` · `Jupyter Notebook` · `Vercel`
